...
return [
     ...
     */
    'title' => "Services GeOsm",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Documentation des services de GeOsm',
    ...
    'routes' => [
        [
             ...
             */
            'exclude' => [
                'api/auth/email/verify/{id}', 'api/auth/email/resend', 'api/auth/phone/verify/{id}', 'api/roles*', 'api/permissions*'
            ],
            ...
            'apply' => [
                ...
                'headers' => [
                    ...
                    'X-Authorization' => '1qsdfRKv65DUYU8sOvAFTmFP9p4SMMmRrIuO5AD5VsNU3I9VgPlbVIpn74S0zM1v'
                ],
